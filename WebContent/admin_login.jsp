...
<title>Exambook - Admin Login</title>
...
<body>
	<%String validate = "Valid email is: a@b.c"; %>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action = login_page method=POST>
					...
					<div class="wrap-input100 validate-input" data-validate ="<%= validate %>" >
